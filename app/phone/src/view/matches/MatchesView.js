Ext.define('FifaApp.view.matches.MatchesView',{
   ...
   // viewModel: {type: 'matchesviewmodel'},
    bind : {
        store: {type: 'matchesstore'},
    },
            ...
            <table style="width: 100%;border: 0px solid green;" >
                <tr>
                    ...
                    <td style="font-size: 16px;">
                        <div style="line-height: 20px;" class="xitem-title">{year}</div>
                        <div style="line-height: 20px;" class="xitem-caption">{home_team_name}</div>
                        <div style="line-height: 20px;" class="xitem-caption">{array_team_name}</div>
